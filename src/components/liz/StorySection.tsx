      ...
      <div className="mx-auto w-full max-w-[88rem] px-5 sm:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            >
              <p>
                From steaming earthen bowls of Matta kanji and fiery Kappa Meen Curry to
                slow-roasted Malabar Pothu and banana-leaf sadya feasts, each recipe celebrates the
                authentic soul of Kerala home cooking.
              </p>
              <p>
                Our tagline —{" "}
                ...
                — reflects our passion for unadulterated traditional flavours, generous
                accompaniments, and honest pricing for our community in Al Karama.
              </p>
            </ScrollReveal>
