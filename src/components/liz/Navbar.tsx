      ...
      >
        ...
        >
          ...
          >
            <Link
              href="/"
              className="flex items-center gap-2 font-display text-2xl font-extrabold tracking-[-0.05em] text-primary sm:text-[1.7rem]"
            >
              <span>{restaurant.shortName}</span>
              <span className="hidden rounded-full bg-primary/10 px-2 py-0.5 font-sans text-xs font-bold text-primary sm:inline">
                {restaurant.nativeName}
              </span>
            </Link>
