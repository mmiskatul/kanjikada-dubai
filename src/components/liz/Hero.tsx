      ...
      <div className="mx-auto grid w-full max-w-[88rem] items-center gap-12 px-5 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        <div>
          ...
          >
            ...
            {restaurant.nativeName} • Kerala Kanji • Al Karama
          </motion.p>
          ...
          >
            Nadan Kanji &amp; Delights.
            <span className="block text-primary">Steaming Hot in Karama.</span>
          </motion.h1>
          ...
          >
            Authentic Kerala Matta Kanji with payar, asthram, kadumanga achar, Kappa &amp; Kottayam
            fish curry, and tender Beef Roast — pure homely nostalgia in Dubai.
          </motion.p>
