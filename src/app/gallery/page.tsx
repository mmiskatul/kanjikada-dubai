...
export const metadata: Metadata = {
  ...
  description:
    "Explore the photo gallery of Kanjikada Dubai (കഞ്ഞിക്കട ദുബായ്) in Al Karama. Steaming Kerala kanji bowls, Kappa Meen curry, nadan fish fry, and our homely dining atmosphere.",
};
    ...
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <PageHeader
          ...
          description="Immerse yourself in the colors, textures, and vibrant culinary presentation of traditional Kerala cooking and kanji sets at Kanjikada Dubai."
        ...
        <section className="py-16 bg-card border-t border-border">
          <div className="mx-auto w-full max-w-4xl px-5 text-center sm:px-8">
            ...
            <p className="mt-3 text-sm text-muted-foreground leading-relaxed max-w-xl mx-auto">
              Share your Kerala kanji feasts, filter coffee pours, and family dinners with us on
              social media using <span className="font-semibold text-primary">#KanjikadaDubai</span>
              .
            </p>
